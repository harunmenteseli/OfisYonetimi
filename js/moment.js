...
!(function (a, b) {
    ...
    var oe = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        pe = "Ocak_Åubat_Mart_Nisan_MayÄ±s_Haziran_Temmuz_AÄŸustos_EylÃ¼l_Ekim_KasÄ±m_AralÄ±k".split("_"),
        qe = "Ocak_Åubat_Mart_Nisan_MayÄ±s_Haziran_Temmuz_AÄŸustos_EylÃ¼l_Ekim_KasÄ±m_AralÄ±k".split("_"),
        re = be,
        se = be;
    U("Y", 0, 0, function () {
        var a = this.year();
    ...
    var ve = "Pazar_Pazartesi_Salı_Çarşamba_Perşembe_Cuma_Cumartesi".split("_"),
        ...
        xe = "Pz_Pzt_Sal_Çrş_Prş_Cu_Cumts".split("_"),
        ye = be,
        ze = be,
        Ae = be;
    U("H", ["HH", 2], 0, "hour"),
    ...
    var Be,
        ...
        Me = /^\/?Date\((\-?\d+)/i,
        Ne = /^((?:Pazartesi|SalÄ±|Ã‡arÅŸamba|PerÅŸembe|Cuma|Cumartesi|Pazar),?\s)?(\d?\d\s(?:Ocak|Åubat|Mart|Nisan|MayÄ±s|Haziran|Temmuz|AÄŸustos|EylÃ¼l|Ekim|KasÄ±m|AralÄ±k)\s(?:\d\d)?\d\d\s)(\d\d:\d\d)(\:\d\d)?(\s(?:UT|GMT|[ECMP][SD]T|[A-IK-Za-ik-z]|[+-]\d{4}))$/;
